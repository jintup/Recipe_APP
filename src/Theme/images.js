const recipe = require('../Theme/recipes/recipe.png');
const spagetti = require('../Theme/recipes/spagetti.png');
const satay = require('../Theme/recipes/satay.png');
const laksa = require('../Theme/recipes/laksa.png');
const nasiLemak = require('../Theme/recipes/nasi-lemak.webp');
